...
pusError_t pus_packetReduced_setDataFromPacketToPacketReduced(pusPacketReduced_t* outTcR, const pusPacket_t* inTc)
{
	...
	switch( inTc->data.u.tcData.data.kind )
	{
		...
		case pus_TC_DATA_ST_19_X:
			...
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_20_1:
			outTcR->data.u.tcData.data.u.st_20_1 = inTc->data.u.tcData.data.u.st_20_1;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_20_2_3:
			outTcR->data.u.tcData.data.u.st_20_2_3 = inTc->data.u.tcData.data.u.st_20_2_3;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_23_X:
			outTcR->data.u.tcData.data.u.st_23_X = inTc->data.u.tcData.data.u.st_23_X;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
...
pusError_t pus_packetReduced_setDataFromPacketReducedToPacket(pusPacket_t* outTc, const pusPacketReduced_t* inTcR)
{
	...
	switch( inTcR->data.u.tcData.data.kind )
	{
		...
		case pus_TC_DATA_ST_19_X:
			...
			break;
		case pus_TC_DATA_ST_20_1:
			outTc->data.u.tcData.data.u.st_20_1 = inTcR->data.u.tcData.data.u.st_20_1;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_20_2_3:
			outTc->data.u.tcData.data.u.st_20_2_3 = inTcR->data.u.tcData.data.u.st_20_2_3;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_23_X:
			outTc->data.u.tcData.data.u.st_23_X = inTcR->data.u.tcData.data.u.st_23_X;
			return PUS_SET_ERROR(PUS_NO_ERROR);
			break;
		case pus_TC_DATA_ST_23_1:
			outTc->data.u.tcData.data.u.st_8_1 = inTcR->data.u.tcData.data.u.st_8_1;
