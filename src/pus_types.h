...
typedef asn1SccPusSt05Event pusSt05EventAuxData_t; //!< Type of the ST[05] event AuxData
...
typedef asn1SccPusByteArray pusSt23RepositoryPath_t; //!< Repository path of a file
typedef asn1SccPusByteArray pusSt23FileName_t; //!< File name
...
typedef asn1SccPusByteArray pusSt23RepositoryDomain_t; //!< Repository domain
typedef asn1SccPusByteArray pusSt23RepositorySystem_t; //!< Repository domain
typedef asn1SccPusUInt32 pusSt23RepositoryId_t; //! RepositoryId

typedef asn1SccPusByteArray pusSt23DirectoryName_t;
typedef asn1SccPusByteArray pusSt23DirectoryDomain_t;
typedef asn1SccPusByteArray pusSt23DirectorySystem_t;
...
#else
typedef enum pusPacketDataKind pusPacketDataKind_t; //!< Type of the union discriminant for asn1SccPusPacketData
typedef enum pusTmDataKind pusTmDataKind_t; //!< Type of the union discriminant for asn1SccPusTmSourceData
typedef enum pusTcDataKind pusTcDataKind_t;  //!< Type of the union discriminant for asn1SccPusTcApplicationData
#endif
*/
...
#define pus_TM_DATA_ST_3_X		((pusTmDataKind_t) st_3_X_PRESENT)
#define pus_TM_DATA_ST_5_X		((pusTmDataKind_t) st_5_X_PRESENT)
#define pus_TM_DATA_ST_5_8		((pusTmDataKind_t) st_5_8_PRESENT)
#define pus_TM_DATA_ST_9_2		((pusTmDataKind_t) st_9_2_PRESENT)
#define pus_TM_DATA_ST_13_X		((pusTmDataKind_t) st_13_X_PRESENT)
#define pus_TM_DATA_ST_13_16	((pusTmDataKind_t) st_13_16_PRESENT)
#define pus_TM_DATA_ST_20_2		((pusTmDataKind_t) st_20_2_PRESENT)
#define pus_TM_DATA_ST_23_4		((pusTmDataKind_t) st_23_4_PRESENT)
#define pus_TM_DATA_ST_23_8		((pusTmDataKind_t) st_23_8_PRESENT)
#define pus_TM_DATA_ST_23_13	((pusTmDataKind_t) st_23_13_PRESENT)


// pusPacketTcDataKind_t
#define pus_TC_DATA_NONE 		((pusTcDataKind_t) PusTmSourceData_NONE)
#define pus_TC_DATA_ST_3_X 		((pusTcDataKind_t) PusTcApplicationData_st_3_X_PRESENT)
#define pus_TC_DATA_ST_5_X 		((pusTcDataKind_t) PusTcApplicationData_st_5_X_PRESENT)
...
#define pus_TC_DATA_ST_11_4		((pusTcDataKind_t) PusTcApplicationData_st_11_4_PRESENT)
#define pus_TC_DATA_ST_12_1_2	((pusTcDataKind_t) PusTcApplicationData_st_12_1_2_PRESENT)
#define pus_TC_DATA_ST_13_X		((pusTcDataKind_t) PusTcApplicationData_st_13_X_PRESENT)
...
#define pus_TC_DATA_ST_19_1		((pusTcDataKind_t) PusTcApplicationData_st_19_1_PRESENT)
#define pus_TC_DATA_ST_19_X		((pusTcDataKind_t) PusTcApplicationData_st_19_X_PRESENT)
#define pus_TC_DATA_ST_20_1		((pusTcDataKind_t) PusTcApplicationData_st_20_1_PRESENT)
#define pus_TC_DATA_ST_20_2_3 	((pusTcDataKind_t) PusTcApplicationData_st_20_3_PRESENT)
#define pus_TC_DATA_ST_23_X 	((pusTcDataKind_t) PusTcApplicationData_st_23_X_PRESENT)
#define pus_TC_DATA_ST_23_1		((pusTcDataKind_t) PusTcApplicationData_st_23_1_PRESENT)
#define pus_TC_DATA_ST_23_11	((pusTcDataKind_t) PusTcApplicationData_st_23_11_PRESENT)
#define pus_TC_DATA_ST_23_12	((pusTcDataKind_t) PusTcApplicationData_st_23_12_PRESENT)
...
#define pus_ST13_MAX_PART_SIZE 1450 //TCP limit
...
#define pus_ST20_PARAM_LIMIT 2000
