...
{
    unsigned int countWrapped = count;
    ...
    if (countWrapped >= pusSequenceCount_LIMIT)
    {
...
void pus_setTmDataKind(pusPacket_t* packet, pusTmDataKind_t kind)
{
...
void pus_setTmNoHeaderDataKind(pusPacket_t* packet, pusTmDataKind_t kind)
{
...
void pus_setTcDataKind(pusPacket_t* packet, pusTcDataKind_t kind)
{
...
void pus_setTcNoHeaderDataKind(pusPacket_t* packet, pusTcDataKind_t kind)
{
